...
pub const ENVIRONMENT_NAME_ALIASES: &[(&str, &str)] = &[
    ...
    // metadata_shard was previously named mdb_shard; support both old prefixes
    ("HF_XET_METADATA_SHARD_TARGET_SIZE", "HF_XET_MDB_SHARD_TARGET_SIZE"),
    ("HF_XET_METADATA_SHARD_MAX_TARGET_SIZE", "HF_XET_MDB_SHARD_MAX_TARGET_SIZE"),
    ("HF_XET_METADATA_SHARD_CACHE_SIZE_LIMIT", "HF_XET_SHARD_CACHE_SIZE_LIMIT"),
    ("HF_XET_METADATA_SHARD_CACHE_SIZE_LIMIT", "HF_XET_MDB_SHARD_CACHE_SIZE_LIMIT"),
    ("HF_XET_METADATA_SHARD_CHUNK_INDEX_TABLE_MAX_SIZE", "HF_XET_CHUNK_INDEX_TABLE_MAX_SIZE"),
    ("HF_XET_METADATA_SHARD_CHUNK_INDEX_TABLE_MAX_SIZE", "HF_XET_MDB_SHARD_CHUNK_INDEX_TABLE_MAX_SIZE"),
